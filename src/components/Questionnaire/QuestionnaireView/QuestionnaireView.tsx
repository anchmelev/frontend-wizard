...
import * as S from './QuestionnaireView.style';
import { StickyCard } from './QuestionnaireView.style';
...
export const QuestionnaireView: React.FC<QuestionnaireViewProps> = ({ questionnaireId }) => {
  ...
  return (
    <StickyCard
      title={<QuestionnaireCardTitle title="Character card" />}
      extra={
        <Space>
          {/* <Popconfirm
